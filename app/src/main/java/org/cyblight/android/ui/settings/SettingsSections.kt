...
internal fun SettingsAppearanceSection(
    ...
    Column(
        ...
        ListItem(
            headlineContent = { Text(stringResource(R.string.settings_home_whats_new_banner)) },
            supportingContent = { Text(stringResource(R.string.settings_home_whats_new_banner_hint)) },
            leadingContent = { Icon(Icons.Outlined.NewReleases, contentDescription = null) },
            trailingContent = {
                Switch(
                    checked = !homeWhatsNewBannerHidden,
                    onCheckedChange = { onHomeWhatsNewBannerHiddenChange(!it) },
                )
            },
        )
    }
...
@Composable
internal fun SettingsGesturesSection(
    ...
    Column(
        ...
        ListItem(
            ...
            trailingContent = {
                Switch(checked = swipeBackEnabled, onCheckedChange = onSwipeBackEnabledChange)
            },
        )
        ListItem(
            ...
            trailingContent = {
                Switch(checked = systemBackEnabled, onCheckedChange = onSystemBackEnabledChange)
            },
        )
        SettingsDropdownRow(
...
@Composable
internal fun SettingsAppLockSection(
    ...
    if (showPinSetup) {
        PinSetupDialog(
            title = stringResource(
                if (appLockPinConfigured) R.string.app_lock_change_pin else R.string.app_lock_setup_pin,
            ),
...
@Composable
internal fun SettingsBackgroundSection(modifier: Modifier = Modifier) {
    val context = LocalContext.current
    Column(
        modifier = modifier
            .fillMaxWidth()
...
internal fun SettingsAboutSection(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.about_creator, stringResource(R.string.about_creator_value)),
...
@Composable
internal fun appLockTimeoutLabel(timeout: AppLockTimeout): String = when (timeout) {
...
@Composable
internal fun swipeBackSensitivityLabel(option: SwipeBackSensitivity): String = when (option) {
...
@Composable
internal fun swipeBackEdgeWidthLabel(option: SwipeBackEdgeWidth): String = when (option) {
...
@Composable
internal fun rootBackBehaviorLabel(option: RootBackBehavior): String = when (option) {
